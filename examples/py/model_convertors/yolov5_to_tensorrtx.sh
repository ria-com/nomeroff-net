...
res_dir="../../../data/model_repository/yolov5s/1"
CLASS_NUM_VALUE=1
...
cd ../../../
mkdir -p ${res_dir}
cp libmyplugins.so ${res_dir}/libmyplugins.so
cp ${yolov5s_engine} ${res_dir}/model.engine
