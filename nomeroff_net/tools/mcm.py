...
model_config_urls = [
    ...
    "https://models.vsp.net.ua/config_model/nomeroff-net-ocr-eu_ua_from_2004/model-efficientnet_b2-512-14.json",
    ...
    # object detection
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov11/model-x-3.json",  # yolov11x
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov11/model-n-3.json",  # yolov11n
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov11_brand_np/model-x-2.json",  # yolov11x_brand_np
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov11_brand_np/model-n-2.json",  # yolov11n_brand_np
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov26/model-x-2.json",  # yolov26x
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov26/model-n-2.json",  # yolov26n
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov26_brand_np/model-x-2.json",  # yolov26x_brand_np
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov26_brand_np/model-n-2.json",  # yolov26n_brand_np
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov8/model-x-2.json",  # yolov8x
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov8_brand_np/model-x-2.json",  # yolov8x_brand_np
    "https://models.vsp.net.ua/config_model/nomeroff-net/np-detector/yolov8_brand_np/model-n-2.json",  # yolov8n_brand_np
