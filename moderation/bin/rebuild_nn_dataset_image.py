...
parser.add_argument('-anb_key', dest="anb_key", required=True, help='Anb key for loadin image settings from  anb/<anb_key>.json')
...
dataset_item = DatasetItem(dataset_config, anb_key, debug)
