...
parser.add_argument('-flag_dir', dest="flag_dir", required=False, help='Path to flag files for check limited boxes')
...
via_boxes.fix_clockwise_via_boxes(target_dir=target_dir,
                                 flag_dir=flag_dir,
                                 filtered_classes=[
                                     "numberplate",
                                     "brand_numberplate",
